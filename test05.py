...
class UIVR2UpgradeToolTestCase(unittest.TestCase):
    ...
    # 接头盔
    def test_app_install_8_driver_over_HMD(self):
        install_lang_window = automation.WindowControl(searchDepth=1,
                                                       ClassName="WindowsForms10.Window.8.app.0.2bf8098_r36_ad1")
        self.current_value = install_lang_window.TextControl().AccessibleCurrentName()
        self.assertEqual(self.current_value, "正在升级，请稍等")
        time.sleep(20)
        self.current_value_1 = install_lang_window.TextControl().AccessibleCurrentName()
        self.assertEqual(self.current_value_1, "升级成功")
        install_lang_window.ButtonControl(Name='确定').Click()

    def test_app_install_9_driver_over_HMD_check(self):
        self.assertFalse(automation.WindowControl(searchDepth=1, ClassName="WindowsForms10.Window.8.app.0.2bf8098_r36_ad1"))
