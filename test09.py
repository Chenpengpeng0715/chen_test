...
class UIVR2UpgradeToolTestCase(unittest.TestCase):
    ...
    def test_app_install_5_select_update_check(self):
        time.sleep(3)
        install_lang_window = automation.WindowControl(searchDepth=1,
                                                       ClassName="WindowsForms10.Window.8.app.0.2bf8098_r36_ad1")
        ...
        time.sleep(60)
        self.assertEqual(self.current_value, "升级成功")

    def test_app_install_6_select_update_argee(self):
        install_lang_window = automation.WindowControl(searchDepth=1,
                                                       ClassName="WindowsForms10.Window.8.app.0.2bf8098_r36_ad1")
        install_lang_window.ButtonControl(Name='确定').Click()

    def test_app_install_7_select_update_argee_check(self):
