...
class PCVRAssistantTestCase(unittest.TestCase):
    ...
    def test_app_install_002(self):
        # 点击【取消】
        self.screen.click(image_config.get_file_path()['cancel_install_english'])
        self.screen.wait(image_config.get_file_path()['Quit_installation'], 1)
        self.assertTrue(self.screen.exists(image_config.get_file_path()['Quit_installation']))
