...
class PCVRAssistantTestCase(unittest.TestCase):
    ...
    def test_app_install_004(self):
        ...
        time.sleep(0.5)
        self.assertTrue(self.screen.exists(image_config.Install.change_folder_file_path))
        self.screen.click(image_config.Install.file_close_path)
        self.assertFalse(self.screen.exists(image_config.Install.change_folder_file_path))
        self.assertTrue(self.screen.exists(image_config.Install.install_home_page_2_path))
