...
class PCVRAssistantTestCase(unittest.TestCase):
    ...
    def test_app_install_002(self):
        # 点击【取消】
        time.sleep(0.5)
        self.screen.click(image_config.get_file_path()['install_cancel'])
        self.screen.wait(image_config.get_file_path()['cancel_install'], 1)
        self.assertTrue(self.screen.exists(image_config.get_file_path()['cancel_install']))
